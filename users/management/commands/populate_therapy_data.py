  ...
  "therapySessions": [
    ...
    },
    {
      ...
      "questions": [
        ...
        "اطلب من الطالب تطبيق خطوات حل المشكلات على سيناريو القلق قبل الامتحان وصعوبة التركيز: تحديد المشكلة، تحليل الأسباب، اقتراح الحلول، اختيار الأنسب، ثم وضع خطة للتنفيذ."
      ]
    },
    {
    ...
    },
    {
      ...
      "questions": [
        ...
        "قدّم سيناريو لطالب يقول: (أنا غير جيد في الدراسة)، واطلب من الطالب إعادة صياغة الفكرة بشكل إيجابي واقتراح بدائل داعمة."
      ]
    },
    {
